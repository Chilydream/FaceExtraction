...
parser.add_argument("--model", type=str, choices=["resnet50, resnet101, vgg16"], default="resnet50",
                    help="model name")
parser.add_argument("--root-path", type=str, default="data/CACD2000/image/",
...
parser.add_argument("--lr", type=float, default=0.001,
                    help="learning rate")
parser.add_argument("--batch-display", type=int, default=100,
...
if __name__ == '__main__':
    trainCACD = FaceRcgTrain(root_path = args.root_path, model_name = args.model, number_classes = args.num_classes, path=args.model_path, loadPretrain=args.pretrained)
